...
\newcommand{\Engineer}{Epsilon} % Epsilon
\newcommand{\Manager}{Omega} % Omega
\newcommand{\Hacker}{Alpha} % Alpha
\newcommand{\Philosopher}{Phi} % Phi
\newcommand{\Mathematician}{Tau} %Tau
\newcommand{\Formalist}{Lambda} % Lambda
\newcommand{\Artist}{Gamma} % Gamma
